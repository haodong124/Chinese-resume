// components/templates/AzurillTemplate.tsx
...
const AzurillTemplate: React.FC<TemplateProps> = ({ resumeData, isPreview = false }) => {
  ...
  return (
    <div className="bg-white text-black font-serif" style={{ fontFamily: 'Merriweather, serif', fontSize: '13px', lineHeight: '1.75' }}>
      <div className="grid grid-cols-3 gap-6 p-6">
        ...
        <div className="col-span-2 space-y-6">
          ...
          <div className="border-b-2 border-yellow-600 pb-4">
            ...
            <p className="text-lg text-yellow-600 font-medium">{personalInfo.title}</p>
                  ...
                  <div key={edu.id}>
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <p className="text-yellow-600">{edu.degree} · {edu.major}</p>
          ...
          <section>
            ...
            <p className="text-black">Available upon request</p>
          </section>
        </div>
        ...
        <div className="space-y-6">
          {/* Profiles */}
          <section>
            <h2 className="text-lg font-bold text-black mb-3 border-b border-gray-300 pb-1">Profiles</h2>
              ...
              <div className="space-y-3">
                {projects.map((project) => (
                  <div key={project.id}>
                    ...
                    <p className="text-sm text-yellow-600">{project.role}</p>
          ...
          {/* Empty sections to match original */}
          <section>
